...
/**
 * Implementation of {@link Log} for DEBUG Logback
 * Created by alexander on 2/5/18.
 */
class DebugLog extends VarArgsSupport implements Log {
    ...
    public <T> T log(String fmt, T arg, Function<? super T, ?> toStr) {
        logger.debug(fmt, toStr.apply(arg));
        return arg;
    }

    @Override
    public <T1, T2> T1 log(String fmt, T1 arg1, Function<? super T1, ?> toStr1, T2 arg2) {
        logger.debug(fmt, toStr1.apply(arg1), arg2);
        return arg1;
    }
